...
*   **`GitHubArtifact.cs`**:
    ...
    *   **Locally Populated**: `BuildInfo` (of type `GitHubBuild`), `RepositoryInfo` (of type `GitHubRepository`).
...
*   **`GitHubWorkflow.cs`**:
    ...
    *   **Locally Populated**: `Artifacts` (a list of `GitHubArtifact`), `RepositoryInfo` (of type `GitHubRepository`).
...
*   `GitHubRepository` provides the necessary configuration for the services to target the correct GitHub repositories.
