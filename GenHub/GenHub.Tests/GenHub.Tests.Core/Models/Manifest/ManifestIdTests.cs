...
public class ManifestIdTests
{
    ...
    /// <summary>
    /// Tests ManifestId with various valid game installation ID formats (5-segment).
    /// </summary>
    ...
    [Theory]
    [InlineData("1.0.steam.generals")] // Too few segments (old 4-segment format no longer valid)
    [InlineData("1.0.invalid.gameinstallation.generals")] // Invalid publisher
    [InlineData("1.0.steam.invalidtype.content")] // Invalid content type
