...
public class ContentDisplayFormatterTests
{
    ...
    public void GetPublisherFromManifest_WithPublisherInfo_ReturnsPublisherName()
    {
        ...
        {
            Id = ManifestId.Create("test.content.v1"),
            Name = "Test Content",
            Version = "1.0",
    ...
    public void CreateDisplayItem_FromManifest_CreatesCorrectItem()
    {
        ...
        var manifest = new ContentManifest
        {
            Id = ManifestId.Create("test.mod.v2"),
            Name = "Test Mod",
            Version = "v2.0",
            ContentType = ContentType.Mod,
            TargetGame = GameType.ZeroHour,
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal("test.mod.v2", result.ManifestId);
    ...
    public void CreateDisplayItemFromInstallation_CreatesCorrectItem()
    {
        ...
        var manifestId = ManifestId.Create("test.manifest.v1");
        ...
        // Assert
        Assert.NotNull(result);
        Assert.Equal("test.manifest.v1", result.ManifestId);
