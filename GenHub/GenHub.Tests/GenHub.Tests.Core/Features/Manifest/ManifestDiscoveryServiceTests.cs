...
public class ManifestDiscoveryServiceTests
{
    ...
    public void GetManifestsByType_FiltersCorrectly()
    {
        ...
        {
            ["1.0.steam.generals"] = new() { Id = "1.0.steam.generals", ContentType = ContentType.GameInstallation },
            ["1.0.genhub.mod.mod1content"] = new() { Id = "1.0.genhub.mod.mod1content", ContentType = ContentType.Mod },
            ["1.0.eaapp.generals"] = new() { Id = "1.0.eaapp.generals", ContentType = ContentType.GameInstallation },
        };
    ...
    public void GetCompatibleManifests_FiltersCorrectly()
    {
        ...
        var manifests = new Dictionary<string, ContentManifest>
        {
            ["1.0.steam.generals"] = new() { Id = "1.0.steam.generals", TargetGame = GameType.Generals },
            ["1.0.eaapp.zerohour"] = new() { Id = "1.0.eaapp.zerohour", TargetGame = GameType.ZeroHour },
            ["1.0.retail.generals"] = new() { Id = "1.0.retail.generals", TargetGame = GameType.Generals },
        };
