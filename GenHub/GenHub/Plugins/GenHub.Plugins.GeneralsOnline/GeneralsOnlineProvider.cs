...
public class GeneralsOnlineProvider : BaseContentProvider
{
        ...
        : base(contentValidator, logger)
    {
        ...
        _deliverer = deliverers.FirstOrDefault(d => d.SourceName.Contains("HTTP"))
            ?? throw new System.InvalidOperationException("No HTTP deliverer found. Ensure a deliverer with 'HTTP' in its SourceName is registered.");
    }
