...
public class MockGameSettingsService : IGameSettingsService
{
    ...
    /// <inheritdoc/>
    public Task<OperationResult<GameSettingsModel>> LoadGameSettingsAsync()
    {
        return Task.FromResult(OperationResult<GameSettingsModel>.CreateSuccess(new GameSettingsModel
        {
            ShowFps = true,
            RenderFpsLimit = 144,
            AutoLogin = true,
    ...
    /// <inheritdoc/>
    public Task<OperationResult<bool>> SaveGameSettingsAsync(GameSettingsModel settings)
    {
