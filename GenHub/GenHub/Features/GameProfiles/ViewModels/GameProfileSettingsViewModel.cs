    ...
    : ViewModelBase
{
    ...
    private readonly IProfileContentLoader? _profileContentLoader = profileContentLoader;
    private readonly IContentDisplayFormatter? _contentDisplayFormatter = contentDisplayFormatter;
    private readonly ILogger<GameProfileSettingsViewModel> _logger = logger ?? NullLogger<GameProfileSettingsViewModel>.Instance;
    private readonly ILogger<GameSettingsViewModel>? _gameSettingsLogger = gameSettingsLogger;
    ...
    [ObservableProperty]
    private ObservableCollection<CoverItem> _availableCovers = new();

    [ObservableProperty]
    private CoverItem? _selectedCover;
    ...
    public GameProfileSettingsViewModel(
        ...
        ILogger<GameProfileSettingsViewModel>? logger,
        ILogger<GameSettingsViewModel>? gameSettingsLogger)
        : this(gameSettingsService, gameSettingsLogger)
    {
    ...
    private async Task SaveAsync()
    {
        try
        {
            ...
            {
                // Create new profile
                // Auto-enable GameClient if needed for launch validation
                if (_gameInstallationService != null)
                {
                    var installationForClient = await _gameInstallationService.GetInstallationAsync(SelectedGameInstallation.SourceId!);
                    if (installationForClient.Success && installationForClient.Data != null)
                    {
                        ...
                        {
                            enabledContentIds.Add(gameClientManifestId);
                            _logger.LogInformation("Auto-enabled GameClient content: {GameClientId}", gameClientManifestId);
                        }
                    }
                }
    ...
    /// <summary>
    /// Scans for available game clients.
    /// </summary>
    [RelayCommand]
    private void ScanForClients()
    {
        // TODO: Implement client scanning logic
        StatusMessage = "Scan for clients: TODO - Implement scanning";
        _logger.LogInformation("ScanForClientsCommand executed");
    }

    /// <summary>
    /// Selects a client from available options.
    /// </summary>
    [RelayCommand]
    private void SelectClient()
    {
        // TODO: Implement client selection logic
        StatusMessage = "Select client: TODO - Implement";
        _logger.LogInformation("SelectClientCommand executed");
    }

    /// <summary>
    /// Browses for an executable.
    /// </summary>
    [RelayCommand]
    private void BrowseExecutable()
    {
        // TODO: Implement file dialog for executable
        StatusMessage = "Browse executable: TODO - Implement file dialog";
        _logger.LogInformation("BrowseExecutableCommand executed");
    }

    /// <summary>
    /// Browses for a data path.
    /// </summary>
    [RelayCommand]
    private void BrowseDataPath()
    {
        // TODO: Implement file dialog for data path
        StatusMessage = "Browse data path: TODO - Implement file dialog";
        _logger.LogInformation("BrowseDataPathCommand executed");
    }
    ...
    private void ValidateProfile()
    {
        ...
        StatusMessage = "Profile validation: TODO - Implement";
        _logger.LogInformation("ValidateProfileCommand executed");
    }

    /// <summary>
    /// Tests launching the game with current profile settings.
    /// </summary>
    [RelayCommand]
    private void TestLaunch()
    {
        // TODO: Implement test launch logic using launcher service
        StatusMessage = "Test launch: TODO - Implement";
        _logger.LogInformation("TestLaunchCommand executed");
    }
