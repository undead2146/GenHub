...
namespace GenHub.Features.GameInstallations
{
    ...
    /// </summary>
    public class GameInstallationDetectionService : IGameInstallationDetectionService
    {
        private readonly IEnumerable<IGameInstallationDetector> _detectors;

        public GameInstallationDetectionService(IEnumerable<IGameInstallationDetector> detectors)
        {
